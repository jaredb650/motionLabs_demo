  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-10">
        ...
        <Link
          href="/"
          className="font-[family-name:var(--font-inter)] text-[11px] uppercase tracking-[0.25em] transition-colors duration-300 hover:opacity-80"
  ...
  return (
    ...
    >
      ...
      <div
        className="pointer-events-none absolute inset-0"
        style={{
          background: `radial-gradient(ellipse 55% 55% at 50% 45%, rgba(255,255,255,0.06) 0%, transparent 70%)`,
        }}
        aria-hidden="true"
      />
      <div
      ...
      >
        ...
        >
          <a
            href="#contact"
            className="inline-block border px-10 py-3 font-[family-name:var(--font-inter)] text-xs uppercase tracking-[0.3em] transition-all duration-500 hover:bg-[#D4A354] hover:text-black"
        ...
        <FadeSection delay={0.2} className="mt-16">
          <form onSubmit={handleSubmit} className="space-y-6">
                ...
                return (
                  <div key={field.name}>
                    ...
                    <textarea
                      ...
                      className="w-full border px-4 py-3 font-[family-name:var(--font-inter)] text-sm outline-none transition-colors duration-300 focus:border-[#D4A354]"
                      style={baseStyles}
                    />
                  </div>
                );
            ...
            <div className="pt-4 text-center">
              <button
                type="submit"
                className="inline-block border px-12 py-3 font-[family-name:var(--font-inter)] text-xs uppercase tracking-[0.3em] transition-all duration-500 hover:bg-[#D4A354] hover:text-black"
